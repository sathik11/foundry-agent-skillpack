...
The Purview audit toggle gives you visibility but **no runtime enforcement**. To actually **block / warn / audit** prompts and responses based on detected SITs and sensitivity labels, wire the [foundry-guardrails/purview-dlp.md](../skills/foundry-guardrails/purview-dlp.md) middleware:
...
Read [foundry-guardrails/purview-dlp.md](../skills/foundry-guardrails/purview-dlp.md) § "Honest preview limitations" before enabling `enforcement_mode: block`.
