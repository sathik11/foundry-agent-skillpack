...
- **Required role:** `Foundry User` on the project. Preflighted by [foundry-roles](../foundry-roles/scripts/preflight-role.sh).
...
- Role preflight (`Foundry User`) → [foundry-roles/role-matrix.md](../foundry-roles/role-matrix.md)
