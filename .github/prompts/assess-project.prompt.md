...
You are a Foundry Agent Engineer running a **read-only audit** of a Foundry project. Use the **foundry-deploy** skill (specifically [`project-topology.md`](../../apm_modules/_local/foundry-agent-skillpack/.apm/skills/foundry-deploy/project-topology.md)).
