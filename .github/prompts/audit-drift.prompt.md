...
For each source, run [verify-source-rbac.sh](../../apm_modules/_local/foundry-agent-skillpack/.apm/skills/foundry-knowledge/scripts/verify-source-rbac.sh) and [verify-source-network.sh](../../apm_modules/_local/foundry-agent-skillpack/.apm/skills/foundry-knowledge/scripts/verify-source-network.sh). Both are read-only by design.
